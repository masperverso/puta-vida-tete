...
Horascsemanales=["€ por dia","0","0","0","0","0","0","0"];
...
function primeralineacalendario() {
         for (i=0;i<7;i++) {
             celda0=f9.getElementsByTagName("th")[i];
             celda0.innerHTML=lasemana[i+1];
             }
         }
...
function escribirdias() {
         ...
         for (i=10;i<22;[i+=2]) { //localizar fila
...
function mifecha() {
         ...
         listameses=document.elegirmes.buscames;
